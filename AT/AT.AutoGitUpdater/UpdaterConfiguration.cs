	...
	{
        public RedisConfiguation RedisConfiguration;

        public TargetApplicationOptions TargetApplicationOptions;
    ...
    public class TargetApplicationOptions
    {
...
public class RedisConfiguation
{
    ...
    public string RedisMessageMustContain;				// A string to look for in the redis message before firing the update routine
}
